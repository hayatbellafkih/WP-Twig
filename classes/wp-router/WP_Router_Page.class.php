...
class WP_Router_Page extends WP_Router_Utility {
	...
	public function __construct($contents, $title, $template = '', $temp_twig) {
		$this->contents = $contents;
		$this->title = $title;
		$this->template = $template;
		$this->twig_template = $temp_twig;
		$this->add_hooks ();
	}
...
if ($redirect_url && get_query_var ( 'WP_Route' )) {
	...
	/**
	 * Some plugins expect certain data in post meta.
	 * It obviously
